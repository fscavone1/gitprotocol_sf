...
/**
 Copyright 2019 Universita' degli Studi di Salerno
...
public interface GitProtocol {
     ...
     */
    boolean createRepository(String _repo_name, File _directory);
    /**
     ...
     */
    boolean addFilesToRepository(String _repo_name, List<File> files);
    /**
     ...
     */
    boolean commit(String _repo_name, String _message);
    /**
